...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/itemloaders-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10417&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/itemloaders-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `itemloaders` can be installed with:

```
conda install itemloaders
```

It is possible to list all of the versions of `itemloaders` available on your platform with:
